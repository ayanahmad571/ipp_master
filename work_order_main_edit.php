...
getHead("WO Edit");
	...
	$getWo = mysqlSelect($UpdatedStatusQuery."
        ...
        where master_wo_status in (1,2,3,4) and master_wo_ref= ".$_GET['id']." 
		".$inColsWO."
  ...
  <span class="selectgroup-button">'.$gusset_bottom['pouch_gusset_bottom_value'].'</span>
        ...
        <div class="row">
            <div class="form-group col-12">
              ...
              <textarea name="work_order_remarks_pouch" class="form-control" placeholder="Remarks" style="height:150px"></textarea>
            </div>
        </div>
    ...
    <div class="section-title">Bags</div>
        ...
        <div class="row">
            <div class="form-group col-12">
              ...
              <textarea name="work_order_remarks_bags" class="form-control" placeholder="Remarks" style="height:150px"></textarea>
            </div>
        </div>
    ...
    <div class="section-title">Slitting</div>
        ...
        <div class="row">
            <div class="form-group col-12">
              ...
              <textarea name="work_order_remarks_slitting" class="form-control" placeholder="Remarks" style="height:150px"></textarea>
            </div>
        </div>
