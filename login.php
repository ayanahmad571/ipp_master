...
<head>
  ...
  <title>Login - <?php echo BRANDING_COMPANY_NAME ?> ERP</title>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12 order-lg-1 min-vh-100 order-1">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold"><?php echo BRANDING_COMPANY_NAME ?> </span>Internal Controls Management System</h4>
