...
getHead("Amendment Form - Accounts");
              ...
              <div class="card card-primary">
                ...
                <div class="card-body text-justify">
                  <table class="table table-striped table-bordered " id="TableZero">
                    ...
                    <tbody>
                      <?php
                      $finalWrap = getAmendmentWrapped($pubQuery, "4");
              ...
              <div class="card card-primary">
                ...
                <div class="card-body text-justify">
                  <table class="table table-striped table-bordered " id="TableOne">
                    ...
                    <tbody>
                      <?php
                      $finalWrap = getAmendmentWrapped($pubQuery, "5");
                      $getDrafts = mysqlSelect($finalWrap);
  ...
  <script>
    ...
    $(document).ready(function(e) {
      $('.discardDraft').click(function(e) {
        ...
        $.post("AmendmentController/AmendmentAccountsController", {
