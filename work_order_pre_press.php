...
<hr id="Splitter" />
	...
	<thead>
		...
		where master_wo_status = 7 order by master_wo_id desc");
		...
		if(is_array($getRecieved)){
			foreach($getRecieved as $Recieved){
                ...
                <tr>
	                ...
	                <button class="loadData btn btn-primary mt-1" data-id="<?php echo ($Recieved['master_wo_ref']); ?>">Check/Update Printing Section</button>
