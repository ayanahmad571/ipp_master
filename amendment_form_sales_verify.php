...
getHead("Amendment Form - Sales Verify");
              ...
              <div class="card card-primary">
                ...
                <div class="card-body text-justify">
                  <table class="table table-striped table-bordered " id="TableZero">
                    ...
                    <tbody>
                      <?php
                      $finalWrap = getAmendmentWrapped($pubQuery, "2");
              ...
              <div class="card card-primary">
                ...
                <div class="card-body text-justify">
                  <table class="table table-striped table-bordered " id="TableOne">
                    ...
                    <tbody>
                      <?php
                      $finalWrap = getAmendmentWrapped($pubQuery, "3");
                      $getDrafts = mysqlSelect($finalWrap);
  ...
  <script>
    $(document).ready(function(e) {
      ...
      $('.discardRej').click(function(e) {
        ...
        bootbox.confirm("Are you sure you want to reject this Amendment Form for Work Order Number " + dataId + " ?", function(result) {
          if (result) {
    ...
    $(document).ready(function(e) {
      $('.discardDraft').click(function(e) {
        ...
        $.post("AmendmentController/AmendmentSalesVerifyController", {
