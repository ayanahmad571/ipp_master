...
*/
	...
	$getWorkOrder= mysqlSelect($UpdatedStatusQuery." where master_wo_status in (1,2,3,4) 
	".$inColsWO."
...
if($doEssentailsModule){
		...
		$WorkOrderMaster = array(
		"master_wo_lum_id"=>$_POST[$essentialNames[2]],
		"master_wo_design_id"=>$_POST[$essentialNames[0]],
		"master_wo_po"=>$_POST[$essentialNames[1]],
		"master_wo_client_id"=>$_POST[$essentialNames[3]],
		"master_wo_customer_item_code"=>$_POST[$essentialNames[5]],
		"master_wo_delivery_date"=>$checkDeliveryDate,
		"master_wo_lwo"=>$_POST[$essentialNames[6]],
		"master_wo_structure"=>$_POST[$essentialNames[7]],
		"master_wo_final_qty"=>$_POST[$essentialNames[8]],
		"master_wo_qty_unit"=>$_POST[$essentialNames[9]],
		"master_wo_tolerance_1"=>$_POST[$essentialNames[10]],
		"master_wo_tolerance_2"=>$_POST[$essentialNames[11]],
		"master_wo_ply"=>$plyNumber,
		"master_wo_application_id"=>$_POST[$essentialNames[13]],
		"master_wo_ncr_no"=>$_POST[$essentialNames[14]],
		"master_wo_ccr_no"=>$_POST[$essentialNames[15]],
		"master_wo_printed_question"=>$_POST[$essentialNames[17]],
		"master_wo_inhouse_pe_question"=>$_POST[$essentialNames[18]]);
		...
		//Check if the posted options are numeric
		if(isset($_POST[$essentialOptions[0]])){
			$WorkOrderMaster['master_wo_customer_location'] = implode(',',$_POST[$essentialOptions[0]]);	
		}
		...
		if(($_POST[$essentialNames[16]] != '')){
			$RemarksMain[] = "(
			'".$USER_ARRAY['lum_id']."',
			'".$_POST[$essentialNames[16]]."',
...
*/
	...
	$WorkOrderPouch= array(
	"master_wo_pouch_qty"=>$_POST[$pouchNames[0]],
	"master_wo_pouch_unit"=>$_POST[$pouchNames[1]],
	"master_wo_pouch_width"=>$_POST[$pouchNames[2]],
	"master_wo_pouch_length"=>$_POST[$pouchNames[3]],
	"master_wo_pouch_gus_side"=>$_POST[$pouchNames[4]],
	"master_wo_pouch_gus_bot"=>$_POST[$pouchNames[5]],
	"master_wo_pouch_seal_width"=>$_POST[$pouchNames[6]],
	"master_wo_pouch_side_gus_w"=>$_POST[$pouchNames[7]],
	"master_wo_pouch_side_gus_l"=>$_POST[$pouchNames[8]],
	"master_wo_pouch_bot_gus_w"=>$_POST[$pouchNames[9]],
	"master_wo_pouch_bot_gus_l"=>$_POST[$pouchNames[10]],
	"master_wo_pouch_euro_punch"=>$_POST[$pouchNames[11]],
	"master_wo_pouch_open"=>$_POST[$pouchNames[12]],
	"master_wo_pouch_corner_type"=>$_POST[$pouchNames[13]],
	"master_wo_pouch_seal_type"=>$_POST[$pouchNames[14]],
	"master_wo_pouch_zip_dist_top"=>$_POST[$pouchNames[15]],
	"master_wo_pouch_notch_side"=>$_POST[$pouchNames[16]],
	"master_wo_pouch_notch_dist_top"=>$_POST[$pouchNames[17]],
	"master_wo_pouch_notch_dist_side"=>$_POST[$pouchNames[18]],
	"master_wo_pouch_hole_punch"=>$_POST[$pouchNames[19]],
	"master_wo_pouch_hole_punch_dia"=>$_POST[$pouchNames[20]],
	"master_wo_pouch_special_tooling"=>$_POST[$pouchNames[21]]);	
	
	//Insert Posted Options into Master Array
	if(isset($_POST[$pouchOptions[0]])){
		$WorkOrderPouch['master_wo_pouch_type'] = implode(',',$_POST[$pouchOptions[0]]);	
	}
	if(isset($_POST[$pouchOptions[1]])){
		$WorkOrderPouch['master_wo_pouch_zip_closure_type'] = implode(',',$_POST[$pouchOptions[1]]);	
	}
	
	

			if(($_POST[$pouchNames[22]] != '')){
				$RemarksMain[] = "(
			'".$USER_ARRAY['lum_id']."',
			'".$_POST[$pouchNames[22]]."',
			'".$getWorkOrder['master_wo_ref']."',
...
if($doBagsModule){
	...
	$WorkOrderBags = array(
	"master_wo_bag_qty"=>$_POST[$bagsNames[0]],
	"master_wo_bag_units"=>$_POST[$bagsNames[1]],
	"master_wo_bag_width"=>$_POST[$bagsNames[2]],
	"master_wo_bag_length"=>$_POST[$bagsNames[3]],
	"master_wo_bag_gus_s_w"=>$_POST[$bagsNames[4]],
	"master_wo_bag_gus_s_l"=>$_POST[$bagsNames[5]],
	"master_wo_bag_gus_b_w"=>$_POST[$bagsNames[6]],
	"master_wo_bag_gus_b_l"=>$_POST[$bagsNames[7]],
	"master_wo_bag_handle_dist_top"=>$_POST[$bagsNames[8]],
	"master_wo_bag_handle_w"=>$_POST[$bagsNames[9]],
	"master_wo_bag_handle_l"=>$_POST[$bagsNames[10]],
	"master_wo_bag_thick"=>$_POST[$bagsNames[11]],
	"master_wo_bag_gusset_side_type"=>$_POST[$bagsNames[12]],
	"master_wo_bag_gusset_bottom_type"=>$_POST[$bagsNames[13]],
	"master_wo_bag_top_fold"=>$_POST[$bagsNames[14]],
	"master_wo_bag_flap"=>$_POST[$bagsNames[15]],
	"master_wo_bag_lip"=>$_POST[$bagsNames[16]],
	"master_wo_bag_handle_type"=>$_POST[$bagsNames[17]],
	"master_wo_bag_vest_hande_type"=>$_POST[$bagsNames[18]]);	

	
	//Insert Posted Options into Master Array
	if(isset($_POST[$bagsOptions[0]])){
		$WorkOrderBags['master_wo_bag_sealing'] = implode(',',$_POST[$bagsOptions[0]]);
		if($specialField){
			$WorkOrderBags['master_wo_bag_spl_dia'] = $_POST[$bagsNames[19]];
		}
	}
	if(isset($_POST[$bagsOptions[1]])){
		$WorkOrderBags['master_wo_bag_handle_punch'] = implode(',',$_POST[$bagsOptions[1]]);	
	}
	
	

				if(($_POST[$bagsNames[20]] != '')){
				$RemarksMain[] = "(
			'".$USER_ARRAY['lum_id']."',
			'".$_POST[$bagsNames[20]]."',
			'".$getWorkOrder['master_wo_ref']."',
...
if($doSlittingModule){
	...
	$WorkOrderSlitting = array(
	"master_wo_slit_s_width"=>$_POST[$slittingNames[0]],
	"master_wo_slit_wind_dir"=>$_POST[$slittingNames[1]],
	"master_wo_slit_roll_od"=>$_POST[$slittingNames[2]],
	"master_wo_slit_wt"=>$_POST[$slittingNames[3]],
	"master_wo_slit_mtr"=>$_POST[$slittingNames[4]],
	"master_wo_slit_pallet"=>$_POST[$slittingNames[5]],
	"master_wo_slit_sticker"=>$_POST[$slittingNames[6]],
	"master_wo_slit_pallet_length"=>$_POST[$slittingNames[7]],
	"master_wo_slit_pallet_width"=>$_POST[$slittingNames[8]],
	"master_wo_slit_pallet_height"=>$_POST[$slittingNames[9]],
	"master_wo_slit_core_id"=>$_POST[$slittingNames[10]],
	"master_wo_slit_core_type"=>$_POST[$slittingNames[11]],
	"master_wo_slit_core_plugs"=>$_POST[$slittingNames[12]],
	"master_wo_slit_reel_flag_col"=>$_POST[$slittingNames[13]],
	"master_wo_slit_qc_max_jointrolls"=>$_POST[$slittingNames[14]]
		...
		//Insert Posted Options into Master Array
	if(isset($_POST[$slittingOptions[0]])){
		$WorkOrderSlitting['master_wo_slit_packing'] = implode(',',$_POST[$slittingOptions[0]]);	
	}

	if(isset($_POST[$slittingOptions[1]])){
		$WorkOrderSlitting['master_wo_slit_pallet_pack_ins'] = implode(',',$_POST[$slittingOptions[1]]);	
	}
	if(isset($_POST[$slittingOptions[2]])){
		$WorkOrderSlitting['master_wo_slit_qc_ins'] = implode(',',$_POST[$slittingOptions[2]]);	
	}
	
		if(($_POST[$slittingNames[15]] != '')){
				$RemarksMain[] = "(
			'".$USER_ARRAY['lum_id']."',
			'".$_POST[$slittingNames[15]]."',
			'".$getWorkOrder['master_wo_ref']."',
			'".time()."',
			'7')";
			}	
