...
if (isset($_POST['amend_work_order_id']) || isset($_POST['amend_reason']) || isset($_POST['amend_mod_1']) || isset($_POST['amend_mod_2']) || isset($_POST['amend_mod_3']) || isset($_POST['amend_notes'])) {
    ...
    logInsert(
        ...
        $USER_ARRAY['lum_id'],
        $_SERVER['REMOTE_ADDR'],
        "Amendment form for REF: " . $_POST['amend_work_order_id'] . " with ID: " . $insertSQL . " has been generated by " . $USER_ARRAY['lum_code'],
        "mysqlInsertData"
    );
}
...
if (isset($_POST['edit_amend_work_order_id']) || isset($_POST['edit_amend_reason']) || isset($_POST['edit_amend_mod_1']) || isset($_POST['edit_amend_mod_2']) || isset($_POST['edit_amend_mod_3']) || isset($_POST['edit_amend_notes'])) {
    ...
    logInsert(
        ...
        $USER_ARRAY['lum_id'],
        $_SERVER['REMOTE_ADDR'],
        "Amendment form for REF: " . $_POST['edit_amend_work_order_id'] . " with ID: " . $checkIn[0]['afm_id'] . " has been edited by " . $USER_ARRAY['lum_code'],
        "mysqlInsertData"
    );
}
