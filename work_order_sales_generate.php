...
<body>
  <div id="app">
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Work Order Generate/Edit - Sales</h1>
          </div>
          <!-- TOP CONTENT BLOCKS -->
    ...
    <div id="formSuccess" class="alert alert-success" style="display:none">
    	<?php if(isset($_GET['draftID'])){ echo 'Draft has Sucessfully been edited';}else{?>This FORM has been saved as a NEW draft.<?php } ?> 
    </div>
...
<div id="workOrderHeaderDetails">
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-12 col-lg-6 col-xl-3">
		  ...
		  if(isset($_GET['repeatFromPublished'])){
			  ?>
              <br><a target="_blank" href="work_order_view_print.php?id=<?php echo $_GET['repeatFromPublished'] ?>">
              <button style="width:100%" class="btn btn-success" type="button"> View <?php echo $_GET['repeatFromPublished']; ?></button></a>
              <?php
		  }
		  ?>
          <input type="<?php echo (isset($_GET['repeatFromPublished'])? "hidden":"text") ?>" class="form-control" name="work_order_lwo"  placeholder="Last Work Order" />
        </div>
...
<div id="workOrderExtrusionProcess">
    ...
    <div class="row">
        <div class="form-group col-12">
          ...
          <textarea name="work_order_remarks_extrusion" class="form-control" placeholder="Remarks" style="height:90px"></textarea>
        </div>
    </div>
    <HR>
</div>
...
<div id="workOrderLaminationProcess">
    ...
    <div class="row">
        <div class="form-group col-12">
          ...
          <textarea name="work_order_remarks_lamination" class="form-control" placeholder="Remarks" style="height:90px"></textarea>
        </div>
    </div>
